...
# for nodejs
# export http_proxy=http://172.23.29.155:3128
# export https_proxy=http://172.23.29.155:3128
# export no_proxy=192.168.100.1

# for java
# export ZEPPELIN_JAVA_OPTS="$ZEPPELIN_JAVA_OPTS -Dhttp.proxyHost=172.23.29.155 -Dhttp.proxyPort=3128 -Dhttps.proxyHost=172.23.29.155 -Dhttps.proxyPort=3128 "

export ZEPPELIN_JAVA_OPTS="$ZEPPELIN_JAVA_OPTS -Djava.net.preferIPv4Stack=true -Dspark.cores.max=4"

# export JAVA_HOME=
# export ZEPPELIN_JAVA_OPTS      		# Additional jvm options. for example, export ZEPPELIN_JAVA_OPTS="-Dspark.executor.memory=8g -Dspark.cores.max=16"
export ZEPPELIN_MEM="-Xmx2048m -Xmn512m -XX:+UseG1GC"
# Zeppelin jvm mem options Default -Xms1024m -Xmx1024m -XX:MaxPermSize=512m
export ZEPPELIN_INTP_MEM="-Xmx4096m"
...
export SPARK_SUBMIT_OPTIONS="--packages org.elasticsearch:elasticsearch-spark-20_2.11:7.2.0,org.apache.spark:spark-sql-kafka-0-10_2.11:2.4.3,org.apache.spark:spark-mllib_2.11:2.4.3,databricks:spark-deep-learning:1.4.0-spark2.4-s_2.11"                   # (optional) extra options to pass to spark submit. eg) "--driver-memory 512M --executor-memory 1G".
...
export PYSPARK_PYTHON=/usr/bin/python3          		# path to the python command. must be the same path on the driver(Zeppelin) and all workers.
# export PYTHONPATH
